        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('messages.form.newregion') }}</li>
                </ol>
            </div>
            <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title"> {{ __('messages.menu.region') }}</h4>
                    </div>
                </div>
                        ...
                        <div class="row form-row">
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title_region"
                                        value="{{ old('title_region') }}" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea cols="30" rows="4" class="form-control"
                                        name="description_region">{{ old('description_region') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
