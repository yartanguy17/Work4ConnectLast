                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="row">
                               ...
                               @if ($offer->logo == null)
                                    ...
                                    @else
                                        <img alt="Card image cap"
                                            src="{{ asset('assets/logo-offer/'.$offer->logo) }}"
                            ...
                            {{-- <div class="col-md-8">
                                <div class="p-2">
                                    <h6 class="font-size-16"><strong>{{ __('welcome.form.typeofcontract') }}</strong></h6>
                                    <p>{{ $offer->typecontrat->title_type_con }}
                                    </p>
                                </div>
                            </div> --}}
                            ...
                            <div class="col-md-4">
                                <div class="p-2">
                                    <h6 class="font-size-16"><strong>{{ __('welcome.form.mission') }}</strong></h6>
                                    <p>{{ $offer->mission }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="p-2">
                                    <h6 class="font-size-16"><strong>{{ __('welcome.form.requiredprof') }}</strong></h6>
                                    <p>{{ $offer->profile }}
                                    </p>
                                </div>
                            </div>
