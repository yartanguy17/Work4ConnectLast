                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <p class="text-danger"><i class="fa fa-user"></i> {{ __('annonce.page.type') }}</p>
                                {{-- @if ($offer->user["personne_type"] == 'entreprise')
                                    <p>Entreprise</p>
                                @else
                                    <p>Particulier</p>
                                @endif --}}
                                <p class="text-danger"><i class="fa fa-city"></i> {{ __('annonce.page.city') }}</p>
                            ...
                            <div class="col">
                                <p class="text-danger"><i class="fa fa-briefcase"></i> {{ __('annonce.page.emp_type') }}</p>
                                <p>{{ $offer->types->title_job_ty }}</p>
                                <p class="text-danger"><i class="fa fa-money"></i> {{ __('annonce.page.salary') }}</p>
                                <p>{{ $offer->expected_salary }}</p>
                                <p class="text-danger"> <i class="fa fa-calendar"></i> {{ __('annonce.page.date_post') }}</p>
                                <p>{{ $offer->start_date->format('d/m/Y') }}</p>
                                <p>{{ $offer->end_date->format('d/m/Y') }}</p>
                                <p class="text-danger"><i class="fa fa-circle-info"></i> Description</p>
                                <p>{{ $offer->types->title_job_ty }}</p>
                            </div>
                        </div>
