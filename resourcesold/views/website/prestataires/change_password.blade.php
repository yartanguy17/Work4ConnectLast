                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <form action="{{ route('prestataire.update_password') }}" method="POST">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-3">
                                                    <label
                                                        for="current-password">{{ __('welcome.form.actupassw') }}</label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="password" class="form-control" placeholder=""
                                                        name="old_password" id="current-password">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-3">
                                                    <label for="new-password">{{ __('welcome.form.newpassw') }}</label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="password" class="form-control" placeholder=""
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-3">
                                                    <label
                                                        for="confirm-new-password">{{ __('welcome.form.passconf') }}</label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="password" class="form-control" placeholder=""
