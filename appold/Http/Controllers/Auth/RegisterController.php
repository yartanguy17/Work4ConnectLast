...
class RegisterController extends Controller
{
    ...
    public function clientRegistration(ClientRequest $request)
    {
        ...
        if (count($checkEmail) > 0) {
            ...
            return back()->with('error', "Phone number $user->phone_number already exists");
            ...
            return redirect()->route('login')->with('success', 'We have sent you an activation code. Check your email and click on the link to verify your account.');
        }
    }
