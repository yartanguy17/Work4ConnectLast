...
@section('content')
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="#">{{ __('messages.menu.region') }}</a></li>
                </ol>
            </div>
            <div class="col-md-4">
                <div class="float-end d-none d-md-block">
                    @can('Creer region')
                        <a href="{{ route('admin.regions.create') }}" class="btn btn-primary" type="button">
                            <i class="mdi mdi-plus me-2"></i> {{ __('messages.form.newregion') }}
                        </a>
                    @endcan
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('messages.form.listreg') }}</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h6 class="table-avatar">
                                            <a href="#">{{ $region->title_region }}</a>
                                        </h6>
                                    </td>
                                    <td>
                                        <div class="form-button-action">
                                            @can('Modifier region')
                                                <a href="{{ route('admin.regions.edit', $region->id) }}"><button
                                            ...
                                            @can('Supprimer region')
                                                <button type="button" onclick="deleteData({{ $region->id }})"
