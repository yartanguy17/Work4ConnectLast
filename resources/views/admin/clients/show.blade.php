                ...
                <div class="card-body">
                    <div class="row form-row">
                        <div class="col-12 col-sm-6">
                            <h4 class="mt-0 font-size-16">{{ __('messages.form.typecustomer') }}</h4>
                            <p>{{ $client->personne_type }}</p>
                        </div>
                        ...
                        @if ($client->personne_type == 'entreprise')
                            <div class="col-12 col-sm-6">
                                ...
                                <p>{{ \Carbon\Carbon::parse($client->date_creation)->format('d/m/Y') }}</p>
                            </div>
                        @endif
                    ...
                    <a href="{{ route('admin.clients.index') }}" class="btn btn-secondary waves-effect mt-4"><i
