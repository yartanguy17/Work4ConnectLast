...
@section('content')
    ...
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h6 class="page-title">{{ __('messages.form.archivedann') }}</h6>
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="#">{{ __('messages.menu.dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="#">{{ __('messages.form.archivedann') }}</a></li>
                </ol>
            </div>
            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('messages.form.archivedann') }}</h4>
                        ...
                        <tbody>
                            @foreach ($offers as $offer)
                                <tr>
                                    ...
                                    <dt>{{ $offer->user["email"] }} | {{ $offer->user["first_name"] }}</dt>
