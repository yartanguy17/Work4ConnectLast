...
@section('content')
    ...
    <div class="page-title-box">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h6 class="page-title">{{ __('messages.form.pendingann') }}</h6>
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="#">{{ __('messages.menu.dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="#">{{ __('messages.form.pendingann') }}</a></li>
                </ol>
            </div>
            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('messages.form.pendingann') }}</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            @endcan
                                            @can('Traiter annonce')
                                                <a href="{{ route('admin.offer.treat', $offer->id) }}"><button type="button"
                                                        data-toggle="tooltip" title="" class="btn btn-primary btn-sm"
                                                        data-original-title="Traiter">
