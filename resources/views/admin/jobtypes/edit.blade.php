    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.jobtypes.update', $type->id) }}"
                        ...
                        <div class="row form-row">
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="title_job_ty"
                                        value="{{ $type->title_job_ty }}" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea cols="30" rows="4" class="form-control"
                                        name="description_job_ty">{{ $type->description_job_ty }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
