                                            ...
                                            <form action="{{ route('client.offers.store') }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="big_form_group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                <label class="form-label">{{ __('welcome.menu.cities') }}
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                <label>Job Apply Page URL</label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <span class="text-danger"> >  {{ $date }} {{ __('welcome.form.day') }}
                                                                    </span>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                <label>{{ __('welcome.form.logo') }} (pdf / jpg / jpeg / png)</label>
