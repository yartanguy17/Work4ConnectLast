    ...
    <div class="page-wrapper">
        ...
        <section>
            <div class="container">
                ...
                <div class="row">
                    <div class="col md 8" style="margin-top: 15%;width: 300px;">
                        ...
                        <div class="col-md-12">
                            <div class="only-form-box-2">
                                ...
                                <form method="POST" action="{{ route('register_client_save') }}"
                                    ...
                                    @csrf
                                    <div class="form-group user_type_cont" style="text-align: center;margin-bottom:1%">
                                        <label class="user_type" for="usertype-1">
                                            <input type="radio" checked name="personne_type" id="usertype-1"
                                                value="particulier"
                                                {{ old('personne_type') == 'particulier' ? 'checked' : '' }} class="my-radio">
                                        ...
                                        <label class="user_type" for="usertype-2">
                                            <input type="radio" name="personne_type" id="usertype-2" value="entreprise"
                                                {{ old('personne_type') == 'entreprise' ? 'checked' : '' }}  class="my-radio">
