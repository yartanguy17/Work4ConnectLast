...
<body>
    <div class="boxed_wrapper">
        ...
        <section class="" style="background-image: url({{ asset('assets/front/images/resources/breadcrumb-bg-2.jpg') }});">
            <div class="container">
                <div class="row">
                      <H2 style="text-align:center;font-size:100px;color:#FFF">ETRE RAPPELE</H2>
                </div>
            </div>
        </section>
        <!--End breadcrumb area-->
                                    ...
                                    <div class="col-md-12">
                                        <div class="only-form-box-2">
                                            ...
                                            <div class="welcome-text text-center mb-5">
                                                <span>Envie d'échanger sur vos besoins ?</span>
                                                <span>Renseignez le formulaire ci-dessous pour être contacté par nos équipes</span>
                                                <h5 class="mb-0">Vous souhaitez être rappelé :</h5>
                                            </div>

                                            <form method="POST" action="{{ route('post_etre_rappele') }}"
                                                ...
                                                <div class="row form-row">
                                                    <div class="col-12 col-sm-6" id="date_section" style="display: none;">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" name="date_rapel" id="date"
                                                                onchange="setCorrect(this,'date');"
                                                                value="{{ old('date_rapel') ?? date('Y-m-d') }}" type="date"
                                                                size="40">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-6" id="plage_horaire_section" style="display: none;">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select" name="horaire_rapel">
