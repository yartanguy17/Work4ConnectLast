                                            ...
                                            @elseif(auth()->user()->type_users == 'client')
                                                <li
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a
                                                                href="{{ route('client.offers.create') }}">{{ __('welcome.menu.announce_create') }}</a>
                                                        </li>
                                                        <!--<li><a-->
                                                        <!--        href="{{ route('client.offers.index') }}">{{ __('welcome.menu.myannounce') }}</a>-->
                                                        <!--</li>-->
                                                        <!--<li><a-->
                                                        <!--        href="{{ route('client.contrat.pending') }}">{{ __('welcome.menu.contrats') }}</a>-->
                                                        <!--</li>-->
                                                        <li><a
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="title" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="{{ __('welcome.form.title') }}"/>
                                          </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group">
                                            <select class="custom-select" id="inputGroupSelect01" name="secteur">
                                                <option  value="">{{ __('welcome.menu.area') }}</option>
                                    ...
                                    <div class="col-2">
                                        <div class="input-group">
                                            <select class="custom-select" id="inputGroupSelect01" name="country">
                                                 <!--<option value=""> Choisire un pays</option>-->
                                                <option  value="">{{ __('welcome.menu.country') }}</option>
                                    ...
                                    <div class="col-2">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name=" city" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="{{ __('welcome.menu.cities') }}"/>
                                          </div>
                                    </div>
