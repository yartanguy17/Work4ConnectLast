                                ...
                                <div class=" job_main_right">
                                    <div class="row job_section">
                                        <div class="col-sm-12">
                                            ...
                                            <form action="{{ route('client.offers.store') }}" method="POST"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" class="form-control"
                                                                    placeholder="" value="{{ old('vacancies') }}"
                                                                    name="vacancies" min="0"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <input type="text" class="form-control" placeholder=""
                                                                    value="{{ old('web-site') }}" name="web_site"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group ">
                                                                ...
                                                                <input type="date" class="form-control" placeholder=""
                                                                    ...
                                                                    required>
                                                                <span class="text-danger"> {{ $date }} {{ __('welcome.form.minimum') }}</span>
                                                            </div>
                                                        </div>
                                                        {{-- <div class="col-md-6">
                                                <div class="form-group">
