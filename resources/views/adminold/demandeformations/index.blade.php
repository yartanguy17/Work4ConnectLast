...
@section('content')
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="#"> {{ __('messages.form.listtrainpro') }}</a></li>
                </ol>
            </div>
            <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title"> {{ __('messages.form.listtrainpro') }}</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            ...
                                            <a href="{{ route('admin.demandeformation.treat', $demande->id) }}"><button
