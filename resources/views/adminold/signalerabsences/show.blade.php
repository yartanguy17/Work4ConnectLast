...
@section('content')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row form-row">
                        <div class="col-12 col-sm-6">
                            ...
                            <p>{{ $signalerabsences->users->last_name }}</p>
                        </div>
                        <div class="col-12 col-sm-6">
                            <h4 class="mt-0 font-size-16">{{ __('messages.form.firstname') }}</h4>
                            <p>{{ $signalerabsences->users->first_name }}</p>
                        </div>
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <p>{{ $signalerabsences->typedemandes->type_absence_name }}</p>
                        </div>
                        <div class="col-12 col-sm-6">
                            <h4 class="mt-0 font-size-16">{{ __('messages.form.pattern') }}</h4>
                            <p>{{ $signalerabsences->motif_demande }}</p>
                        </div>
                        <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12 col-sm-6">
                            ...
                            <p> {{ $signalerabsences->date_effet ? date('d/m/Y', strtotime($signalerabsences->date_effet)) : 'N/A' }}
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-12 text-let">
            <a class="btn btn-primary" href="{{ route('admin.signalerabsences.index') }}"><i
