        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('messages.form.newtypeholiday') }}</li>
                </ol>
            </div>
            <div class="col-md-4">
                <div class="float-end d-none d-md-block">
                    <a href="{{ route('admin.typeconges.index') }}" class="btn btn-success" type="button">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        <h4 class="card-title">{{ __('messages.form.newtypeholiday') }}</h4>
                    </div>
                </div>
                <form method="POST" action="{{ route('admin.typeconges.store') }}">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="type_conge_name"
                                        value="{{ old('type_conge_name') }}" autocomplete="off">
                                </div>
                            </div>
                        </div>
                    </div>
