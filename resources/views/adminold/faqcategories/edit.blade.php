    ...
    <div class="row">
        <div class="col-lg-6 offset-lg-3">
            ...
            <div class="card">
                ...
                <form method="POST" action="{{ route('admin.faqcategories.update', $category->id) }}"
                        ...
                        <div class="row form-row">
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" type="text" name="title_faq_cat"
                                        value="{{ $category->title_faq_cat }}" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea cols="30" rows="4" class="form-control"
                                        name="description_faq_cat">{{ $category->description_faq_cat }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
