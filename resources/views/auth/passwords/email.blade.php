                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="com_class_form">
                                    <div class="form-group">
                                        <label><span class="normal-font-w">Mot de passe perdu? Veuillez saisir votre
                                                adresse mail. Vous recevrez un lien pour créer un nouveau mot de passe
                                                par e-mail. </span></label>

                                        <input class="form-control @error('email') is-invalid @enderror" name="email"
                                            value="{{ old('email') }}" required autocomplete="email" autofocus
                                            type="email" name="email" size="40" placeholder=" Adresse email * ">
