...
Route::get('/login-register', 'Website\LoginController@index')->name('login-register');
Route::get('/cv', 'Website\CvController@index')->name('cv');
...
Route::get('/recherche/prestataire', 'Website\SearchController@getSearch')->name('search');
...
Route::get('lang/{locale}', 'Website\HomeController@lang');
...
Route::name('client.')->group(function () {
    ...
    Route::group(['prefix' => 'client'], function () {
        ...
        Route::resource('offers', 'Website\Client\OfferController');
          // Reservation d'un Pretataire par un Client 10 yoyo edem
        ...
        Route::post('post/offer', 'Website\Client\ClientController@addoffer')->name('addoffer');
        // Contrats du Client
...
Route::name('admin.')->group(function () {
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::get('cv', 'cv@admin_cv')->name('cv');
        Route::get('cv/details', 'cv@get_cv')->name('cv_details');
